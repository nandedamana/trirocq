...
Section linux_tnum_subtraction.
  ...
  Lemma xy_eq_nxy x y z : bit_and x y = bit_and (bit_not x) z -> bit_and y z = zero.
    unfold bit_not. unfold bit_and. destruct x; destruct y; destruct z; auto.
  Qed.
  ...
  (* borrows generated by dv and beta *)
  ...
  (* borrow generated by dv and the carry generated by alpha *)
